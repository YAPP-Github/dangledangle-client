...
export const H1 = withTypographyBase('h1', 'h1');
export const H2 = withTypographyBase('h2', 'h2');
export const H3 = withTypographyBase('h3', 'h3');
export const H4 = withTypographyBase('h4', 'h4');
